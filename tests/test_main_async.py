...
class TestMongoDBManager:
    ...
    def test_get_distinct_documents_from_collection(self, mongodb_manager):
        ...
        mongodb_manager.insert_many_document_in_collection(items=items)
        ...
        distinct_documents = (
            mongodb_manager.get_distinct_documents_from_collection(
                field="name"
            )
        )
    ...
    def test_insert_document_in_collection(self, mongodb_manager):
        ...
        mongodb_manager.insert_document_in_collection(item=item)
    ...
    def test_update_document_in_collection_based_on_id(self, mongodb_manager):
        ...
        assert isinstance(data, dict)
        assert (
            data["test_one_item_update_document_in_collection_based_on_id"]
            == "test_one_item_update_document_in_collection_based_on_id"
        )
        assert (
            data["id_update_document_in_collection_based_on_id"]
            == "test_id_update_document_in_collection_based_on_id"
        )
        assert f"{collection_name}_id" in data.keys()
        # Ensure to have a date field in the collection
        assert "date" in data.keys()
        ...
        data[
            "test_one_item_update_document_in_collection_based_on_id"
        ] = "test_one_item_update_document_in_collection_based_on_id_updated"
        print("data", data)
    ...
    def test_update_many_documents_in_collection_based_on_id(
        ...
        mongodb_manager.update_many_documents_in_collection(
            items=items, collection_id_name="id_update_many"
        )
        collection = mongodb_manager.get_collection()
        items = mongodb_manager.get_all_documents_from_collection()
